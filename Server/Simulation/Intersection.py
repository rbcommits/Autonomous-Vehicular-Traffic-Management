...
class Intersection:
    ...
    def updateIntersectionContainers(self, carList, time):
        ...
        for i in range(0, len(carList)):
            ...
            if(carList[i].positionX >= self.positionX - self.width * 4 and carList[i].positionX <= self.positionX and 
            ...
            if(carList[i].positionY >= self.positionY - self.length * 4 and carList[i].positionY <= self.positionY and
